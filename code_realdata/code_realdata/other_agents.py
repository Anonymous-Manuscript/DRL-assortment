...
class OA_agent:
    ...
    def reset(self,initial_inventory,T):
        ...
        self.i = 0
    def step(self,arriving_seg,arriving_cus):
        OA_ass = self.OA()
        index_,reward = self.market.step(arriving_seg, arriving_cus, OA_ass)
...
class myopic_agent:
    ...
    def step(self,arriving_seg,arriving_cus):
        ...
        choose_index,reward = self.market.step(arriving_seg, arriving_cus, myopic_ass)
        self.total_reward += reward
...
class E_IB_agent:
    ...
    def step(self,arriving_seg,arriving_cus):
        ...
        choose_index, reward = self.market.step(arriving_seg, arriving_cus, IB_ass)
        self.total_reward += reward
...
class sub_t_agent:
    ...
    def step(self,arriving_seg,arriving_cus):
        ...
        choose_index, reward = self.market.step(arriving_seg, arriving_cus, sub_t_ass)
        self.total_reward += reward   
...
class DP_Greedy_agent:
    ...
    def step(self,arriving_seg,arriving_cus):
        ...
        choose_index, reward = self.market.step(arriving_seg, arriving_cus, DP_Greedy_ass)
        self.total_reward += reward
        if self.t<self.T-1:
            self.t += 1        
