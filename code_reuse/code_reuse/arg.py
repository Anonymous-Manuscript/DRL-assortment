...
def init_parser(alg):
    if alg == 'A2C':
        ...
        parser.add_argument('--w', nargs='+', default=[64, 128], type=int)
        ...
        parser.add_argument('--reuse_type', default='prod', type=str, help='prod,cus,rand')
        parser.add_argument('--stream', default='0', type=str, help='name of experiment')
        parser.add_argument('--saved_time_stream', default='2024-10-20-23-33-05', type=str, help='name of saved experiment')
        ...
        parser.add_argument('--ini_inv', default=12, type=int, help='initial inventory')
